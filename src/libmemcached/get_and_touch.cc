...
char *memcached_get_and_touch(memcached_st *ptr, const char *key, size_t key_length,
                              size_t *value_length, time_t expiration, uint32_t *flags,
                              memcached_return_t *error) {
  return memcached_get_and_touch_by_key(ptr, NULL, 0, key, key_length, value_length, expiration,
                                        flags, error);
}
...
char *memcached_get_and_touch_by_key(memcached_st *shell, const char *group_key,
...
//                                              const bool is_group_key_set, const char *const
...
//                                          const size_t *key_length, size_t number_of_keys) {
//   Memcached *ptr = memcached2Memcached(shell);
//   return mget_by_key_real(ptr, group_key, group_key_length, keys, key_length, number_of_keys,
//   true);
// }
//
...
//                                                  size_t group_key_length, const char *const
//                                                  *keys, const size_t *key_length, size_t
//                                                  number_of_keys, memcached_execute_fn *callback,
...
//                                              const size_t *key_length, const size_t
//                                              number_of_keys, const bool mget_mode) {
...
// #if 0
//     {
//       memcached_return_t vk= memcached_validate_key_length(key_length[x],
//       ptr->flags.binary_protocol); if (memcached_failed(rc= memcached_key_test(*memc, (const char
//       **)&key, &key_length, 1)))
//       {
...
//     if ((x > 0 and x == ptr->io_key_prefetch) and memcached_flush_buffers(ptr) !=
//     MEMCACHED_SUCCESS)
//     {
//       rc = MEMCACHED_SOME_ERRORS;
//     }
...
//   memcached_return_t rc = MEMCACHED_NOTFOUND;
//   uint32_t start = 0;
//   uint64_t randomize_read = memcached_behavior_get(ptr,
